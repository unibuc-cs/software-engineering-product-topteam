...
import { User, MessageSquare, BookOpen, FileText, ShoppingCart, LogOut, Plus } from "lucide-react"
...
const professorNavItems = [
  ...
  { name: "Assign Homework", href: "/professor/assign-homework", icon: FileText },
]
...
export function Navbar({ user }: NavbarProps) {
  ...
  const navItems = user.role === "student" ? studentNavItems : professorNavItems
